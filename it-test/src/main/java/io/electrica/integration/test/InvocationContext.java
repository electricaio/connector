package io.electrica.integration.test;
...
import io.electrica.integration.test.security.SecuredAuthorization;
 ...
 * {@link io.electrica.integration.spi.ConnectorExecutorFactory#create(ServiceFacade)}.
 *
 * @see #builder(Enum)
 * @see #builder(String)
 */
